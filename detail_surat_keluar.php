...
<div style="max-width:800px">
    <div style="display:flex;gap:10px;margin-bottom:20px">
        ...
        <a href="edit_surat_keluar.php?id=<?= $id ?>" class="btn btn-accent btn-sm"><i class="fas fa-edit"></i> Edit</a>
        <a href="hapus_surat.php?type=keluar&id=<?= $id ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus?')"><i class="fas fa-trash"></i> Hapus</a>
    </div>
    <div class="card">
        <div class="card-header">
            <h3><i class="fas fa-paper-plane"></i> Detail Surat Keluar</h3>
        ...
        <div class="card-body">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px">
                <div>
                    ...
                    <div style="margin-bottom:18px">
                        <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:var(--text-muted);margin-bottom:5px">Tujuan / Penerima</div>
                        <div style="font-size:14px;font-weight:600"><?= htmlspecialchars($s['tujuan']) ?></div>
                    </div>
                    <div style="margin-bottom:18px">
            ...
            <div style="border-top:1px solid var(--border);padding-top:16px">
                <div style="font-size:11px;font-weight:700;text-transform:uppercase;color:var(--text-muted);margin-bottom:8px">Keterangan</div>
            ...
            <div style="border-top:1px solid var(--border);padding-top:16px;margin-top:16px">
                <div style="font-size:11px;font-weight:700;text-transform:uppercase;color:var(--text-muted);margin-bottom:8px">File Surat</div>
                <a href="uploads/surat/<?= $s['file_surat'] ?>" target="_blank" class="btn btn-outline"><i class="fas fa-file-download"></i> Unduh File Surat</a>
            </div>
            <?php endif; ?>
        </div>
    </div>
